...
public class Repository extends Thread {
    ...
    public Repository(FileDir localDirectory, int listeningPortTCP, MensagemTCP msg2, Socket client2) {
    ...
    public void enviaListaFicheiros(){
        ...
        try {
            ...
            output.writeObject(listaFicheiros);
            output.flush();
        }catch(IOException e){}
    } //TESTAR
        ...
        System.out.println("From: "+ client.getInetAddress()+":"+client.getPort()+" - "+msg.getMsg());
         ...
         switch (msg.getMsg()){
             ...
             case  "down":
                 ...
                 enviaFicheiro(msg.getFile().getFileName());
                 break;
             case "up":
                 System.out.println("Upload: " + msg.getFile().getFileName());
                 recebeFicheiro(msg.getFile().getFileName());
                 break;
             case "del":
